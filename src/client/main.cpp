...
int main(int argc, char **argv)
{
    ...
    for (;;)
    {
        ...
        // 读取成功后，丢弃多余字符（避免残留换行影响后续getline）
        cin.ignore(10000, '\n');
        // ============================================================
        ...
        case 1: // login业务
        {
            ...
            // ===================== 修复登录输入校验 =====================
            // 校验userid是否为有效数字，失败则直接返回菜单
            if (!(cin >> id))
            {
                cin.clear();
                cin.ignore(10000, '\n');
                cerr << "userid must be a number!" << endl;
                continue;
            }
            cin.ignore(10000, '\n'); // 清理残留换行
            // ============================================================
